...
char buffer[MAXLINE];
 ...
 if(connect(connfd,(struct sockaddr*)&sock_var,sizeof(sock_var))>=0)
 {
  ...
  printf("===================================================================\n\n");
  printf("Welcome to the System Administrator Portal\n\n");
    printf("===================================================================\n\n");
  printf("Avaiable commands...\n");
  printf("<add_airline> to add a new airline into the database.\n");
  printf("<view_airline> to view the airline information.\n");
  printf("<remove_airline> to remove a airline from the database.\n");
